...
const PrivacyPage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <SEO
        title={t('legalDocuments.privacy.metaTitle', 'Politique de Confidentialité')}
        description={t('legalDocuments.privacy.metaDescription', 'Découvrez comment Moderateur Bedones protège vos données lors de la modération de vos commentaires Facebook et Instagram. Conformité RGPD et sécurité des données.')}
      />
