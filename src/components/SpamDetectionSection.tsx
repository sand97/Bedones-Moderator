  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-3">
        ...
        />
        <Label htmlFor="spam" className={`text-base font-medium ${enabled ? 'text-black' : 'text-gray-600'}`}>
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleContent className="mt-4 ml-6 space-y-3">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="hide-spam" className={`text-sm ${action === 'hide' ? 'text-black' : 'text-gray-600'}`}>{t('spamDetection.hide')}</Label>
            </div>
            <div className="flex items-center space-x-2">
              <input
                type="radio"
                ...
                className="w-4 h-4 accent-black border-gray-300"
              />
              <Label htmlFor="delete-spam" className={`text-sm ${action === 'delete' ? 'text-black' : 'text-gray-600'}`}>{t('spamDetection.delete')}</Label>
            </div>
          </CollapsibleContent>
        </Collapsible>
    </div>
